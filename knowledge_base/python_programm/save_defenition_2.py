...
# 1) сохранение в локальный список
#     проверка на существование
#     запись
# 2) перевод в глобальный
#     проверка на существование
#     запись

# нужны ли в нутри субпроцесса доступ к локальным структурам?
# все хотелаь бы в core делать

тут нужно не просто веруть ноды как в палка продемонстрованно, нужно получить доступ к полям локалных списоков
