...
# количество совпадений слов из предложения со словами из определения слова
# "два"
...
if __name__ == '__main__':
    ...
    #####
    # рабочий фрагмент демонстрации работы с графами и определениями
    # g = Graph()
    ...
    # пока нельзя выполнять, т к нет сравнения текущего времени с правильным
    # ответом
